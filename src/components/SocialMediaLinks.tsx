interface SocialMediaLink {
  mediaName: 'instagram' | 'github' | 'linkedin';
  href: string;
  icon: string;
}
...
const socialMediaLinks: SocialMediaLink[] = [
  {
    mediaName: 'instagram',
    href: 'https://www.instagram.com/stanimitrov',
